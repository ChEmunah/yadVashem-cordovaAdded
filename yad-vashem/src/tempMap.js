...
export class CurrentMap extends Component {
    ...
    //     //  console.log('fileTransfer', new fileTransfer());
    ...
    render() {
        return (
            <div>
                ...
                <img src = "https://maps.googleapis.com/maps/api/staticmap?center=Yad+Vashem&zoom=17&size=700x500&maptype=roadmap&markers=color:blue%7Clabel:S%7C40.702147,-74.015794&markers=color:green%7Clabel:G%7C40.711614,-74.012318&markers=color:red%7Clabel:C%7C40.718217,-73.998284&key=AIzaSyCOkNwkwX1xa59m94TYXKXzmBYBnhQZCGE" alt = "map"/>
